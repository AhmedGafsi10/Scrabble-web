...
describe('StartGameSoloComponent', () => {
    ...
    describe('otherEvents', () => {
        ...
        describe('function joinRoom tests ', () => {
            ...
            // TODO: fix tests
            // it('should set the hasGameType bool to false if there is an invalid gameType', () => {
            //     component.gameData = gameDataStub;
            //     component.room.roomInfo.gameType = 'invalidType';
            //     component.joinRoom();
            //     expect(component.hasGameType).toBeFalse();
            // });

            // it('should set the hasGameType bool to true if there is a valid gameType', () => {
            //     component.gameData = gameDataStub;
            //     component.joinRoom();
            //     expect(component.hasGameType).toBeTruthy();
            // });
        });
    });
    describe('gameData tests', () => {
        ...
        //     spyOn(component, 'dictionarySelectedExists' as any).and.returnValue(of(true));
        //     component.gameData = gameDataStub;
        //     const formDictionary = gameDataStub.dictionary;
        //     await component.joinRoom();
        //     const formDictionary = gameDataStub.controls.dictionary as FormControl;
        //     expect(component.room.roomInfo.dictionary).toEqual(formDictionary);
        // });
    });
