...
import { ChatMessage, MessageSenderColors } from '@app/services/message';
...
export class ChatComponent implements OnInit {
    ...
    chatForm: FormGroup;
    isEmojiPickerActive: boolean = false;
    ...
    ngOnInit() {
        ...
        this.focusHandlerService.currentFocus.subscribe(() => {
            if (!this.focusHandlerService.isCurrentFocus(CurrentFocus.CHAT)) {
                this.closeEmojiPicker(); // TODO test this
                return;
            }
    ...
    // TODO : refactor handleSubmit and sendScrabbleMesssage ? line1 and 2
    sendScrabbleMessage() {
