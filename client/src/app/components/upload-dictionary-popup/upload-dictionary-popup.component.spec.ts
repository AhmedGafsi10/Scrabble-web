...
describe('UploadDictionaryPopupComponent', () => {
    ...
    describe('onFileSelected tests', () => {
        ...
        // This is something that we want to test because we want to be able to display the name of the invalid file
    ...
    // TODO add more tests
    // TODO remove  spyOn(dictionaryValidator, 'isDictionaryValid').and.returnValue(true); lines ?
