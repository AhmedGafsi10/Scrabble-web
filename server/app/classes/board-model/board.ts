...
import { BoardMessageContent, BoardMessageTitle, CENTRAL_COLUMN_INDEX, DEFAULT_CENTRAL_ROW, Directions, PlacementDirections } from './constants';
...
export class Board {
    ...
    checkRulesRespected(placementTest?: boolean) {
