...
import { CENTRAL_COLUMN_INDEX, DEFAULT_CENTRAL_ROW } from '@app/classes/board-model/constants';
...
export class VirtualPlayer extends Player {
    ...
    /* updatePlacementFinder(newBoardManipulator: BoardManipulator) {
        this.tools.finder.updateBoardManipulator(newBoardManipulator as BoardManipulator2990);
    }*/
    private setGreeting() {
    ...
    private placeLettersActionExpert() {
        this.possiblePlacements = this.tools.finder.getPlacement(SCORE_INTERVALS.any, this.rack.getLetters());
