import { BoardMessageTitle, CENTRAL_COLUMN_INDEX, DEFAULT_CENTRAL_ROW, Directions, PlacementDirections } from '@app/classes/board-model/constants';
...
export class PlacementFinder {
    ...
    getPlacement(targetScore: ScoreInterval, availableLetters: string) {
        this.possiblePlacements = [];
